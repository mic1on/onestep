...
@router.post("/channels", response_model=NotificationChannelSummary, status_code=status.HTTP_201_CREATED)
...
@router.patch("/channels/{channel_id}", response_model=NotificationChannelSummary)
...
@router.delete("/channels/{channel_id}", response_model=NotificationChannelDeleteResponse)
