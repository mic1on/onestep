...
dsl_weekly = CronBroker(Cron.weekly(on=["mon", "fri"], at="10:30"), body="DSL 每周一/周五 10:30")
macro_workdays = CronBroker("@workdays", body="宏：工作日 00:00")
macro_every_1m = CronBroker("@every 1m", body="宏：每 1 分钟")

@step(from_broker=[once_broker, dsl_every_30s, dsl_weekly, macro_workdays, macro_every_1m])
