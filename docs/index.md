...
features:
  ...
  - title: 多种 Source/Sink
    details: 内置 Memory、Interval、Cron、Webhook 和 HTTP Sink，并通过插件支持 RabbitMQ、Redis Streams、AWS SQS、Cloudflare Queues、MySQL、PostgreSQL、MongoDB、Elasticsearch/OpenSearch、ClickHouse、Kafka 和 Feishu Bitable。
  - title: 可组合流水线
