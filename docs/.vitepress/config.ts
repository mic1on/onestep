        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'SQL <Badge type="tip" text="MySQL" /> <Badge type="tip" text="PostgreSQL" />', link: '/en/broker/sql' },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'SQL <Badge type="tip" text="MySQL" /><Badge type="tip" text="PostgreSQL" />', link: '/broker/sql' },
