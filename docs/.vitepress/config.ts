        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'MySQL <span class="VPBadge warning" style="font-size:10px;line-height:16px;padding:0 6px;transform:none;">即将下线</span>', link: '/en/broker/mysql' },
              { text: 'PostgreSQL <span class="VPBadge warning" style="font-size:10px;line-height:16px;padding:0 6px;transform:none;">即将下线</span>', link: '/en/broker/postgres' },
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '指标与健康检查', link: '/guide/metrics' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'MySQL <span class="VPBadge warning" style="font-size:10px;line-height:16px;padding:0 6px;transform:none;">即将下线</span>', link: '/broker/mysql' },
          { text: 'PostgreSQL <span class="VPBadge warning" style="font-size:10px;line-height:16px;padding:0 6px;transform:none;">即将下线</span>', link: '/broker/postgres' },
